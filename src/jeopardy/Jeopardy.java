...
public class Jeopardy implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		// If the buttonPressed was the secondButton
			...
			askQuestion("Who play's Tony Stark?", "Robert Downey Junior", 600);
			thirdButton.setText("");
		} else if (buttonPressed == fourthButton) {
			askQuestion("What is the villain's name in Captain America: Civil War", "Helmut Zemo", 800);
			fourthButton.setText("");
		} else if (buttonPressed == fifthButton) {
			askQuestion("Who was the first Marvel hero to get a sequel?", "Iron Man", 1000);
		}
